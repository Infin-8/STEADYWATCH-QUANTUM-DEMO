...
(function () {
    ...
    function initGame() {
        ...
        camera.position.set(2.62, 6.52, 2.62);
        camera.lookAt(0, 5, 0);
        ...
        var beaconFlares = [
            ...
            { sc: 5.5, r: 168, g: 85,  b: 247, op: 0.40 },
            { sc: 9.5, r: 168, g: 85,  b: 247, op: 0.12 }
        ].map(function(d) {
    ...
    for (let i = 0; i < keyDrops.length; i++) {
        ...
        function updateKeyLabel(drop) {
            ...
            if (drop) {
                ...
                labelEl.textContent = 'Key #' + drop.keyIndex + ' (p=17) ' + q + ' — click/tap key ore to mine';
            } else {
